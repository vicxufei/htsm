...
CREATE TABLE `#__brand` (
  ...
  `brand_bgpic` varchar(100) DEFAULT NULL COMMENT '品牌背景标识',
  `brand_tjstore` int(10) DEFAULT NULL COMMENT '品牌店铺推荐',
  `brand_introduction` text DEFAULT NULL COMMENT '品牌详情介绍',
...
('stat_pricerange', ''),
('store_joinin_pic', 'a:2:{s:3:"pic";a:2:{i:1;s:18:"store_joinin_1.jpg";i:2;s:18:"store_joinin_2.jpg";}s:8:"show_txt";s:263:"shopwwi【B2B2C】平台提供各类专业管家服务，协助您开通店铺、运营店铺、组织营销活动及分析运营数据，悉心为您解答各类疑问，引导您按相关规则展开运营；我们将竭尽全力，为您的店铺保驾护航。";}'),
('subdomain_edit', '0'),
