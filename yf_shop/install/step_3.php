    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="40" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'shopwwi';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
        ...
        <div>
          <label>数据库表前缀</label>
          <span>
          <input type="text" name="db_prefix" maxlength="20" value="<?php echo $_POST['db_prefix'] ? $_POST['db_prefix'] : 'shopwwi_';?>">
          </span> <em>同一数据库运行多个ShopWWI程序时，请修改前缀</em></div>
        <div>
          <label>数据库端口</label>
          <span>
