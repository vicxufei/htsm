...
class member_orderControl extends BaseMemberControl {
    ...
    public function indexOp() {
        ...
        Tpl::output('show_page',$model_order->showpage(5));

        self::profile_menu($_GET['recycle'] ? 'member_order_recycle' : 'member_order');
        Tpl::display2('member_order');
    }
    ...
    public function show_orderOp() {
        ...
        Tpl::display2('member_order_detail');
    ...
    private function _order_receive($order_info, $post) {
        ...
        $logic_order->changeOrderStateReceive($order_info,'buyer',$_SESSION['member_name'],'签收了货物');
    }
    ...
    private function _order_recycle($order_info, $get) {
        ...
        $logic_order->changeOrderStateRecycle($order_info,'buyer',$state_type);
    }
