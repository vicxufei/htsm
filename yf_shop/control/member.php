...
class memberControl extends BaseMemberControl{
    ...
    //
    //    Tpl::display('member_home.member_info','null_layout');
    //}
    ...
    public function ajax_load_order_infoOp() {
        ...
        Tpl::display('member_home.order_info','null_layout');
    }
    ...
    public function ajax_load_goods_infoOp() {
        ...
        Tpl::display('member_home.goods_info','null_layout');
    }
    ...
    public function ajax_load_sns_infoOp() {
        ...
        Tpl::display('member_home.sns_info','null_layout');
    }
}
