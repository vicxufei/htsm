...
class store_goods_addControl extends BaseSellerControl {
    ...
    public function save_goodsOp() {
        ...
        $debugPostData = array (
            ...
            'sp_val' => array (
                5 => array ( 341 => '16G', 342 => '32G', ),
                6 => array ( 343 => '黑色', 344 => '粉色', ),
                7 => array ( 346 => '4.7寸', ), ),
            'spec' => array (
                'i_341343346' => array (
                    'goods_id' => '',
                    'sp_value' => array ( 341 => '16G', 343 => '黑色', 346 => '4.7寸', ),
                    'marketprice' => '9999',
                    'price' => '9000',
                    'stock' => '10',
                    'alarm' => '0',
                ...
                'i_341344346' => array (
                    'goods_id' => '',
                    'sp_value' => array ( 341 => '16G', 344 => '粉色', 346 => '4.7寸', ),
                    'marketprice' => '9999',
                    'price' => '9001',
                    'stock' => '11',
                    'alarm' => '0',
                    'sku' => '',
                    'barcode' => '', ),
                'i_342343346' => array ( 'goods_id' => '', 'sp_value' => array ( 342 => '32G', 343 => '黑色', 346 => '4.7寸', ), 'marketprice' => '9999', 'price' => '9002', 'stock' => '12', 'alarm' => '0', 'sku' => '', 'barcode' => '', ),
                'i_342344346' => array ( 'goods_id' => '', 'sp_value' => array ( 342 => '32G', 344 => '粉色', 346 => '4.7寸', ), 'marketprice' => '9999', 'price' => '9003', 'stock' => '13', 'alarm' => '0', 'sku' => '', 'barcode' => '', ), ),
            'g_storage' => '46',
            'g_alarm' => '',
            'g_serial' => '',
            'g_barcode' => '',
            'g_weight' => '',
            'image_path' => '1_05383960723357367.jpg',
            'goods_image' => '',
            'jumpMenu' => '0',
            'b_name' => '',
            'b_id' => '',
            'search_brand_keyword' => '',
            'attr' => array ( 26 => array ( 'name' => 'CPU', 0 => '不限', ), ),
            'g_body' => '',
            'add_album' => '',
            'plate_top' => '请选择',
            'plate_bottom' => '请选择',
...
//        if($_SERVER["REMOTE_ADDR"] == '49.64.22.145'){
            $goods_commonid = $result['data'];
            $model_goods = Model('goods');
            $goods_array = $model_goods->getGoodsList(array('goods_commonid' => $goods_commonid), 'goods_barcode');
            foreach ($goods_array as $goods_item){
                $res = yf_crul('goods','add','barcode',$goods_item['goods_barcode']);
//                var_export($res);
            }
//        }
