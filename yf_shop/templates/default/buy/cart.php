...
<?php } ?> /></td>
        ...
        <tr>
          <td colspan="20"><?php if ($is_chain) { ?>
            <div class="ncc-chain-tip"><strong>*</strong>该订单中包含支持“门店自提”服务的商品，如需到店自提，请选择提交
                <a data_store_id="<?php echo $store_id ?>" nc_type="chain" href="javascript:void(0)"><i class="icon-truck"></i>门店自提订单</a></div>
            <?php } ?></td>
        </tr>
        <?php } ?>
      </tbody>
