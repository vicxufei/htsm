...
<div class="sale">
  <ul>
    ...
    <li>
      <div class="goods-thumb" style=" background-image:url(<?php echo gthumb($val['groupbuy_image1'], 'small');?>);"><a href="<?php echo urlShop('show_groupbuy','groupbuy_detail',array('group_id'=> $val['groupbuy_id']));?>" mpf="sqde" target="_blank">&nbsp;</a></div>
      <dl>
