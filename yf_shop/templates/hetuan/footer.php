            ...
            { ?>
                ...
                <dl>
                    ...
                    <dd><p>错过天猫？别再错过我们！</p>
                        ...
                        <p>太划算商城开启全新旅程！</p><a href="<?php echo urlShop('show_joinin', 'index'); ?>" class="btn"
        ...
        <div class="wrapper">
            <div class="screen clearfix">
                <div class="fl right-flag"><a href="http://www.shopwwi.com" target="_blank" rel="nofollow"><img
                            src="<?php echo SHOP_SITE_URL; ?>/img/credit-flag3.png"></a><a href="http://www.htths.com/"
                                                                                           target="_blank"
                                                                                           rel="nofollow"><img
                ...
                <div class="fl about-us"><p><a
                    ...
                    <p>CopyRight © 2014-2017 太仓和团商贸有限公司 <a href="http://www.miibeian.gov.cn/" target="_blank" mpf="sqde"
