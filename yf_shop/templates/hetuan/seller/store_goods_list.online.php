...
<form method="get" action="index.php">
  <table class="search-form">
    ...
    <tr>
      <td>
          当前按上架时间排序,&nbsp;<a href="<?php echo urlShop('store_goods_online', 'goods_list2');?>" class="ncbtn ncbtn-mint">按库存排序</a>
      </td>
      <th>供货商</th>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><div class="pic-thumb"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$val['goods_commonid']]['goods_id']));?>" target="_blank"><img src="<?php echo yf_cthumb($val['goods_image']);?>" data-pic="<?php echo thumb($val, 60);?>"/> </a></div></td>
