...
<?php } ?>
    ...
    <dl>
      ...
      <dd>
        <input id="upper_limit" name="upper_limit" type="text" class="text w130" value="<?php echo empty($output['xianshi_info'])?'1':$output['xianshi_info']['upper_limit'];?>"/><span></span>
        <p class="hint">参加活动的最高购买数量，默认为0(不限购)</p>
      </dd>
    </dl>
    <div class="bottom">
