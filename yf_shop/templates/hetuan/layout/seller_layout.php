...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    ...
    <div class="center-logo">
        <a target="_blank" href="http://mall.htths.com/crontab/index.php?act=hour&op=xs_clear" class="ncbtn ncbtn-mint" title="发布新商品">删除商品缓存</a>
        <a target="_blank" href="http://mall.htths.com/crontab/index.php?act=hour&op=xs_create" class="ncbtn ncbtn-mint" title="发布新商品">新建商品缓存</a>
        <a target="_blank" href="http://mall.htths.com/crontab/index.php?act=hour&op=xs_update" class="ncbtn ncbtn-mint" title="发布新商品">更新</a>
    </div>
