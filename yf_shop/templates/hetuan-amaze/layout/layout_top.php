...
<header class="am-topbar">
    <div class="am-g am-g-fixed am-g-collapse">
        <ul class="am-topbar-left am-avg-sm-30">
            <?php if ($_SESSION['is_login'] == '1'){ ?>
                <li class="sn-login-normal">
                    <?php echo $lang['nc_hello']; ?>
                    <a rel="nofollow" href="<?php echo urlShop('member', 'home'); ?>"><?php echo $_SESSION['member_name']; ?></a>
                    <span class="split"></span>
                    <a rel="nofollow" href="<?php echo urlLogin('login', 'logout'); ?>"><?php echo $lang['nc_logout']; ?></a>
                </li>
            <?php } else{ ?>
                <li><?php echo $lang['nc_hello'] . $lang['nc_comma'] . $lang['welcome_to_site'] .$output['setting_config']['site_name']; ?>!请
                    <a href="<?php echo urlMember('login'); ?>"><?php echo $lang['nc_login']; ?></a>
                    <span class="split"></span>
                    <a href="<?php echo urlLogin('login', 'register'); ?>"><?php echo $lang['nc_register']; ?></a>
                </li>
            <?php } ?>
        </ul>
        <ul class="am-topbar-right am-avg-sm-70">
            <li class="jMenu">
                <a class="menu-hd block-item" href="http://i.yunhou.com">我的云猴<b class="arrow"></b></a>
                <div class="menu-bd" style="display: none; height: 104px; padding-top: 5px; margin-top: 0px; padding-bottom: 5px; margin-bottom: 0px;">
    ...
    <div class="topbar wrapper">
        <div class="user-entry">
            ...
            { ?>
                ...
                <span>[<a
                        href="<?php echo urlLogin('login', 'logout'); ?>"><?php echo $lang['nc_logout']; ?></a>] </span>
            <?php } else
            { ?>
      ...
      <?php } ?>
                    ...
                    { ?>
                        <a href="<?php echo MEMBER_SITE_URL; ?>/api.php?act=tosina"
            ...
            <?php } ?> <span>[<a href="<?php echo urlMember('login'); ?>"><?php echo $lang['nc_login']; ?></a>]</span>
                <span>[<a
        ...
        <div class="quick-menu">
            ...
            { ?>
                <dl class="down_app">
                    <dt><a href="<?php echo BASE_SITE_URL; ?>/wap">移动端</a><i></i></dt>
                    <dd>
            ...
            <dl>
                <dt>
                    <a href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_favorite_goods&op=fglist"><?php echo $lang['nc_favorites']; ?></a><i></i>
                </dt>
                <dd>
                    <ul>
                        <li>
