...
<div class="appbar-btnbox">
<?php if ($output['cart_list']['list']) { ?>
<div yf_id="appbar_total_price" class="total-price">共计金额：<em class="goods-price">&yen;<?php echo $output['cart_list']['cart_all_price'];?></em></div>
<a class="btn btn-danger" href="javascript:void(0);" onclick="javascript:window.location.href='<?php echo SHOP_SITE_URL;?>/index.php?act=cart'">结算购物车中的商品</a>
<?php } ?>