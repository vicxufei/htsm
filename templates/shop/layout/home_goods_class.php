        ...
        { ?>style="display:none;"<?php } ?>>
            <div class="class"><?php if ($val['cn_pic'] != '')
                { ?><span class="ico"><img src="<?php echo $val['cn_pic']; ?>"></span><?php } ?><h4><a
                        href=" <?php if (!empty($val['channel_id']))
                        {
                        ...
                        } ?>"><?php echo $val['gc_name']; ?></a></h4><span class="arrow"></span></div>
            <div class="sub-class" cat_menu_id="<?php echo $val['gc_id']; ?>">
                <div class="sub-class-content">
                    ...
                    { ?>
                        <dl>
                        <dt>
                        <h3><a href="<?php if (!empty($v['channel_id']))
                            {
                                echo urlShop('channel', 'index', array('id' => $v['channel_id']));
                            }
                            else
                            {
                                echo urlShop('search', 'index', array('cate_id' => $v['gc_id']));
                            } ?>"><?php echo $v['gc_name']; ?></a></h3></dt>
