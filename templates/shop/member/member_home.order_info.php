...
<div id="shopping" class="normal">
  <div class="outline">
    ...
    <div class="mb-cart-list">
      <ul>
        <?php foreach($output['cart_list'] as $cart_info) { ?>
        <li>
          <div class="goods-thumb"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=>$cart_info['goods_id']));?>"><img src="<?php echo thumb($cart_info,60);?>"></a></div>
          <dl class="goods-info">
