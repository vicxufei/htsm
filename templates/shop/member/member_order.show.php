    ...
    <div class="ncm-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><span><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>，</span>
              <span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?>，</span>
              <span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?></span></dd>
        </dl>
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
          <dd>
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        <li>1. 商品已发出；
          ...
          <?php if ($output['order_info']['if_deliver']) { ?>查看 <a href="#order-step" class="blue">“物流跟踪”</a> 情况。<?php } ?>
          <?php } else { ?>
          无需要物流。
          <?php } ?>
        </li>
