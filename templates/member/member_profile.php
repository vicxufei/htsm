  ...
  <dl>
    ...
    <dd>会员等级：
      <?php if ($output['member_info']['level_name']){ ?>
        <div class="mb-grade-mini" style="cursor:pointer;" onclick="javascript:go('<?php echo urlShop('pointgrade','index');?>');"><?php echo $output['member_info']['level_name'];?>会员</div>
      <?php } ?>
    </dd>
      ...
      <form method="post" id="profile_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_information&op=member">
        ...
        <dl>
          ...
          <dd>
              ...
              <?php if ($output['member_info']['level_name']){ ?>
              <div class="mb-grade-mini" style="cursor:pointer;" onclick="javascript:go('<?php echo urlShop('pointgrade','index');?>');"><?php echo $output['member_info']['level_name'];?></div>
              <?php } ?>
              </span>
