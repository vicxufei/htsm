...
function _dfsockopen($url, $limit = 0, $post = '', $cookie = '', $bysocket = FALSE, $ip = '', $timeout = 55, $block = TRUE, $encodetype  = 'URLENCODE', $allowcurl = TRUE) {
	$return = '';
	...
	if(function_exists('curl_init') && function_exists('curl_exec') && $allowcurl) {
        ...
        $curlUrl = $scheme.'://'.($ip ? $ip : $host).':'.$port.$path;
