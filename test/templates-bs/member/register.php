        ...
        <div class="mb-register-mode">
          ...
          <div id="tabs_container" class="tabs-container">
            <div id="default" class="tabs-content">
              <form id="register_form" method="post" class="mb-login-form" action="<?php echo urlLogin('login', 'usersave');?>">
            ...
            <div id="mobile" class="tabs-content">
              <form id="post_form" method="post" class="mb-login-form">
                <?php Security::getToken();?>
                <input type="hidden" name="form_submit" value="ok" />
                <input name="nchash" type="hidden" value="<?php echo getNchash();?>" />
                <dl>
              ...
              <form style="display: none;" id="register_sms_form" class="mb-login-form" method="post" action="<?php echo urlLogin('connect_sms', 'register');?>">
                <input type="hidden" name="form_submit" value="ok" />
...
$(function(){
	...
	$(".mb-register-mode .tabs-nav li a").click(function(){
