...
<ul>
  ...
  <li class="inv_item <?php echo $k == 0 ? 'selected' : null; ?>">
  ...
  <div id="add_inv_box" style="display:none">
    <form method="POST" id="inv_form" action="index.php">
      ...
      <div id="invoice_panel" class="cart-form">
        <dl>
      ...
      <div id="vat_invoice_panel" class="cart-form" style="display:none">
        <dl>
...
<div class="hr16">
    <a id="hide_invoice_list" class="btn btn-grapefruit" href="javascript:void(0);"><?php echo $lang['cart_step1_invoice_submit'];?></a>
    <a id="cancel_invoice" class="btn ml10" href="javascript:void(0);">不需要发票</a></div>
<script>
