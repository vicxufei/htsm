...
class wxpay_jsapi
{
    ...
    public function __construct()
    {
        $this->config = (object) array(
            ...
            'finishedUrl' => WAP_SITE_URL . '#myorder',
            'undoneUrl' => WAP_SITE_URL . '#myorder',
...
EOB;
    ...
    {
        //$_GET['code'] = '001pF0r92rBLNC0TmBr92vq1r92pF0ri';
        if (empty($_GET['code'])) {
            ...
            $url = sprintf(
                'http://www.htths.com/get-weixin-code.html?appid=%s&scope=snsapi_base&state=hello-world&redirect_uri=%s',
                $this->config->appId,
                urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'])
            );
