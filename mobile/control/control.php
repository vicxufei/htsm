...
class mobileControl{
    ...
    //客户端类型
    protected $client_type_array = array('android', 'wap', 'wechat', 'ios', 'windows','app');
    //列表默认分页数
    protected $page = 5;
...
//			if($mb_user_token_info['client_type']!='wap' && empty($mb_user_token_info['device_id']) && in_array($mb_user_token_info['app_version'], array('00.00.23','2.0.15'))  ){
//                //重新登录后以前的令牌失效
//                $condition = array();
...
//            }
			...
			if(empty($this->member_info)) {
				...
				$this->member_info['device_id'] = $mb_user_token_info['device_id'];
