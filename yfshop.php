...
define('ByYfShop',true);
define('StartTime',microtime(true));
define('TIMESTAMP',time());
define('DIR_SHOP','yf_shop');
...
define('TPL_MAIN',BASE_ROOT_PATH.'/dist');   //重新定义模板路径
define('TPL_SHOP_NAME','hetuan');
//define('TPL_SHOP_NAME','default');
//if($_SERVER["REMOTE_ADDR"] == '121.224.111.9'){
//    define('TPL_SHOP_NAME','hetuan');
//}else{
//    define('TPL_SHOP_NAME','default');
//}
 ...
 * 商品图片
 */
define('GOODS_IMAGES_WIDTH', '60,240');
define('GOODS_IMAGES_HEIGHT', '60,240');
define('GOODS_IMAGES_EXT', '_60,_240');
