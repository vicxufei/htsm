...
class groupbuyModel extends Model{
     ...
     *
     */
    public function getGroupbuyInfoByGoodsCommonID($goods_commonid,$field = '*') {
        ...
        if (empty($info)) {
            ...
            $groupbuy_goods_list = $this->getGroupbuyExtendList($condition, null, 'start_time asc', $field, 1);
