$(function(){
        ...
        $(".item").hover(
          function() {
              $(this).find(".goods-info").animate({"top": "184px"}, 400, "swing");
          },function() {
        ...
        $(window).resize(function() {
            $('a[yftype="add_cart"]').click(function() {
                flyToCart($(this));
            });
        });
        $('a[yftype="add_cart"]').click(function() {
        ...
        function flyToCart($this) {
            var appbar_offset_left = $("#appbar_cart").offset().left;
            var appbar_offset_top = $("#appbar_cart").offset().top-$(document).scrollTop();
            ...
            flyer.fly({
                start: {
                    ...
                    left: appbar_offset_left,
                    top: appbar_offset_top,
                    width: 0,
                    height: 0
                },
                onEnd: function(){
        ...
        // 立即购买
        $('a[yftype="buy_now"]').click(function(){
