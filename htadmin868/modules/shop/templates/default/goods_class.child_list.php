    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="60" align="center">POS分类</th>
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $v['gc_id'];?>">
          ...
          <td class="sort"><span title="<?php echo $lang['nc_editable'];?>" column_id="<?php echo $v['gc_id'];?>" fieldname="gc_sort" nc_type="inline_edit" class="editable "><?php echo $v['gc_sort'];?></span></td>
            <td class="sort"><span title="<?php echo $lang['nc_editable'];?>" column_id="<?php echo $v['gc_id'];?>" fieldname="pos_gcid" nc_type="inline_edit" class="editable "><?php echo $v['pos_gc_id'];?></span></td>
