    ...
    public function brand_addOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                $brand_country_array = explode(',',$_POST['brand_country']);
                $insert_array['brand_country_code'] = $brand_country_array[0];
                $insert_array['brand_country_en'] = $brand_country_array[1];
                $insert_array['brand_country_zh'] = $brand_country_array[2];
    ...
    public function brand_editOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                $brand_country_array = explode(',',$_POST['brand_country']);
                $update_array['brand_country_code'] = $brand_country_array[0];
                $update_array['brand_country_en'] = $brand_country_array[1];
                $update_array['brand_country_zh'] = $brand_country_array[2];
