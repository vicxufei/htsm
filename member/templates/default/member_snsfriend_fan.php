  ...
  <ul class="ncm-friend-list">
    ...
    <li id="recordone_<?php echo $v['friend_frommid']; ?>">
      ...
      <dl class="info">
        ...
        <dd><a href="<?php echo urlMember('member_message', 'index', array('member_id' => $v['friend_frommid']));?>" target="_blank" title="<?php echo $lang['nc_message'] ;?>"><i class="icon-envelope"></i><?php echo $lang['nc_message'] ;?></a></dd>
      </dl>
